...
Make sure to place the `~/.composer/vendor/bin` directory in your PATH so the `laravel` executable can be located by your system. If you are using ZSH, you may need to use `$HOME/.composer/vendor/bin` as ZSH does not expand the `~` alias.
